    ...
    <RevealOnScroll>
     ...
     <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
        ...
        <p className="text-gray-300 mb-6">
            Passionate developer with exppetise in building scalable web 
     ...
     <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
                    ...
                    <ul className="list-disc list-inside text-graay-300 space-y-2">
                        <li>
                            <strong>Bachelor of Science in Computer Science</strong>-Dnanprassarak Mandal's College (2021-2024)
                        </li>
                        <li>
                            <strong>Master of Science in Information Technology</strong>-Parvatibai Chowgule College of Arts and Science (2024-2026)
                        </li>
